...
async def test_tree_of_thoughts_game_of_24():
    ...
    print(f"✅ Game of 24 Problem")  
    print(f"✅ Solution: {result['solution']}")
    print(f"✅ Score: {result['score']:.2f}")
    print(f"✅ Has errors: {result.get('has_errors', True)}")
...
async def test_tree_of_thoughts_beam_search():
    ...
    print(f"✅ Creative Problem Solution:")
    print(f"✅ Best Game: {result['solution'][:100]}...")
    print(f"✅ Final beam size: {result['final_beam_size']}")
    print(f"✅ Candidates explored: {result.get('all_candidates_explored', 0)}")


if __name__ == "__main__":
    # Run tests directly
    async def run_tests():
        print("🧪 Testing TreeOfThoughtsAgent with LangGraph routing...")
        ...
        print("🎉 All TreeOfThoughtsAgent tests passed!")
