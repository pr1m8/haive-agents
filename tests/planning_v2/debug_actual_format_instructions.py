    ...
    try:
        ...
        for i, msg in enumerate(formatted.messages):
            ...
            if "format_instructions" in msg.content:
                print("     ✅ format_instructions variable found in content")
            elif "JSON schema" in msg.content:
                print("     ✅ JSON schema found in content")
            elif "output should be formatted" in msg.content.lower():
                print("     ✅ Format guidance found in content")
            else:
                print("     ❌ No format instructions found in content")
