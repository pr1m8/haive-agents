...
def test_format_instructions():
    ...
    if "format_instructions" in partial_vars:
        ...
        print("   ❌ Format instructions missing!")
    ...
    try:
        ...
        if "format_instructions" in partial_vars:
            ...
            print("   ❌ Still no format_instructions after manual setup")
    ...
    if "format_instructions" in v1_partials:
        print("   ✅ V1 has format_instructions")
    else:
        print("   ❌ V1 also missing format_instructions")
