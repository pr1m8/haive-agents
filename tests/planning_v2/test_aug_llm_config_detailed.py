...
def detailed_debug():
    ...
    if "format_instructions" in template.partial_variables:
        ...
        print(f"   ❌ No format_instructions in partial_variables")
        
        # Maybe it's somewhere else?
        all_partials = template.partial_variables
        print(f"   All partial variables:")
