...
def test_validation_node_with_exact_message():
    ...
    try:
            ...
            if hasattr(last_message, 'tool_call_id'):
                ...
                if hasattr(last_message, 'content'):
                    try:
                        ...
                        print(f"   ✅ Content successfully parsed as Plan[Task]!")
        ...
        print(f"   Result saved to: /tmp/validation_node_test_result.json")
        ...
        print(f"   Error saved to: /tmp/validation_node_test_error.json")
        return False, None
...
def test_manual_parse_output_route():
    ...
    try:
        ...
        print(f"   ✅ Successfully created Plan[Task]!")
        print(f"   Objective: {plan.objective}")
...
if __name__ == "__main__":
    ...
    print(f"\n📄 Debug files saved:")
    print(f"   - /tmp/validation_node_test_result.json (or _error.json)")
    print(f"   - /tmp/validation_node_debug_message.json (from previous test)")
    print(f"   - /tmp/aug_llm_raw_result.json (from previous test)")