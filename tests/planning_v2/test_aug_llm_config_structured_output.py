...
def test_aug_llm_config_structured_output():
    ...
    try:
        ...
        print("   Raw result saved to: /tmp/aug_llm_raw_result.json")
        ...
        if isinstance(result, Plan):
            ...
            print("   ⚠️  Result is not Plan[Task], investigating...")
            ...
            if hasattr(result, "content"):
                try:
                    ...
                    print("   ✅ Content can be parsed as Plan[Task]!")
        ...
        print("   Message saved for validation debugging: /tmp/validation_node_debug_message.json")
        ...
        print("   Error saved to: /tmp/aug_llm_error.json")
        return False, None
...
if __name__ == "__main__":
    ...
    if success:
        print("✅ SUCCESS: AugLLMConfig with Plan[Task] works!")
        print("📄 Files saved for validation node debugging:")
        print("   - /tmp/aug_llm_raw_result.json")
        print("   - /tmp/validation_node_debug_message.json")
    else:
        print("❌ FAILED: AugLLMConfig execution failed")
        print("📄 Error saved to: /tmp/aug_llm_error.json")
