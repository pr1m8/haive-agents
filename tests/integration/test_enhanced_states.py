...
def test_v2_workflows():
    ...
    try:
        ...
        print("\n✓ MultiCriteriaGradedRAGAgentV2 created")
        print(f"  Initial config: {agent._initial_config}")
    ...
    try:
        ...
        print("\n✓ AdaptiveThresholdRAGAgentV2 created")
        print(f"  Initial config: {agent._initial_config}")
