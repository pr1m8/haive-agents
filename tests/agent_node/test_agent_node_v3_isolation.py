...
class TestAgentNodeV3Isolation:
    ...
    def test_react_agent_v3_with_structured_output(self):
        ...
        state = MultiAgentState(
            ...
            messages=[{"role": "user", "content": "Calculate 15 * 23 and analyze the result"}]
        )
    ...
    def test_direct_agent_execution_comparison(self):
        ...
        try:
            ...
            print(f"   Has get_latest_structured_output: {hasattr(result_invoke, 'get_latest_structured_output')}")
