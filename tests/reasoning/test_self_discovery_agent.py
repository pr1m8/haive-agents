...
def test_self_discovery_agent():
    ...
    try:
        ...
        if hasattr(state, "reasoning_modules"):
            print("   ✅ Has reasoning_modules fieldd")
        if hasattr(state, "selected_modules"):
            print("   ✅ Has selected_modules fieldd")
        if hasattr(state, "adapted_modules"):
            print("   ✅ Has adapted_modules fieldd")
        if hasattr(state, "reasoning_structure"):
            print("   ✅ Has reasoning_structure fieldd")
        if hasattr(state, "final_answer"):
            print("   ✅ Has final_answer fieldd")
    ...
    try:
        ...
        print("   ✅ Self-discovery execution completedd")
