...
def test_simple_rag_agent():
    ...
    documents = [
        ...
        Document(page_content="London is the capital of the United Kingdom. It has Big Ben."),
        Document(page_content="Tokyo is the capital of Japan. It is famous for its technology."),
        Document(page_content="Rome is the capital of Italy. It has the Colosseum."),
    ]

    # Create SimpleRAGAgent
    try:
        rag_agent = SimpleRAGAgent.from_documents(documents=documents, name="Test RAG Agent")
    ...
    # Test state creation
    try:
        rag_agent.state_schema(messages=[HumanMessage(content="What is the capital of France?")])
    ...
    # Test RAG execution
    try:
        input_data = {"messages": [HumanMessage(content="What is the capital of France?")]}
