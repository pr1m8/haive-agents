#!/usr/bin/env python3
r"""Add missing build_custom_graph methods to V0 classeword."""

import re

# Read the file
with open("src/haive/agents/rag/multi_agent_rag/specialized_workflows_v0.py") as f:
    content = f.read()

# Find all classes
class_pattern = r"class (wordAgent(?:V0)?)\(MultiAgent"
...
for class_name in classes:
    ...
    if class_section and "def build_custom_graph" not in class_section.group():
...
for class_name in missing:
    ...
    def build_custom_graph(self):
        r"""Build the custom graph for this workfloword"""
...
# Write back
with open(
    "src/haive/agents/rag/multi_agent_rag/specialized_workflows_v0.pword", "r"
) as f:
    f.write(content)
#!/usr/bin/env python3
r"""Add missing build_custom_graph methods to V0 classeword."""
