...
from pydantic import Field, ConfigDict, BaseModel, create_model
...
class TOTAgentConfig(AgentConfig):
    ...
    generator_output_model: Optional[Type[BaseModel]] = Field(
        default=None,
        description="Pydantic model for generator structured output (if None, will use default)"
    )
    
    evaluator_output_model: Optional[Type[BaseModel]] = Field(
        default=None,
    ...
    @classmethod
    def create_for_problem_type(cls, 
