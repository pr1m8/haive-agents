...
from typing import List, Optional, Union, Dict, Any, Literal, TypeVar, Generic
...
class Score(BaseModel):
    ...
    """
    value: float = Field(
        description="Numerical score between 0 and 1",
        ge=0,
        le=1
    )
...
def update_candidates(existing: Optional[List[Any]] = None, 
                     updates: Optional[Union[List[Any], str]] = None) -> List[Any]:
    """
