...
class DocumentLoaderRecommendationInput(BaseModel):
    ...
    data_types: list[str] | None = Field(None, description="Types of data needed (web, academic, news, etc.)")
...
def load_github_issues(repo: str, access_token: str | None = None, state: str = "open") -> dict[str, Any]:
...
try:
    class TavilySearchInput(BaseModel):
        ...
        search_depth: str | None = Field("basic", description="Search depth (basic or comprehensive)")
