...
from haive.agents.complex_extraction.models import PatchFunctionParameters
...
class RetryStrategy(TypedDict, total=False):
    ...
    fallback: Runnable[Sequence[AnyMessage], AIMessage] | Runnable[Sequence[AnyMessage], BaseMessage] | Callable[[Sequence[AnyMessage]], AIMessage] | None
