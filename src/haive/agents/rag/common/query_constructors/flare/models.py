...
class FLAREStep(BaseModel):
    ...
    search_queries: list[str] = Field(
        default_factory=list, description="Specific search queries for missing information"
    )
...
class FLAREResponse(BaseModel):
    ...
    generation_steps: list[FLAREStep] = Field(description="Steps in the FLARE generation process")
    ...
    confidence_assessment: str = Field(description="Overall confidence in the final answer")
