...
from haive.agents.research.open_perplexity.models import ResearchSummary, ResearchSource, ResearchFinding
...
engines["source_evaluation"] = AugLLMConfig(
    ...
    llm_config=AzureLLMConfig(model="gpt-4o",temperature=0.1),  # Lower temp for objective evaluation
