...
from typing import Optional, List, Dict, Union, Annotated, Sequence, Any
...
class ResearchState(BaseModel):
    ...
    confidence_level: Optional[ResearchConfidenceLevel] = Field(
        default=None,
...
class ResearchInputState(BaseModel):
    ...
    research_parameters: Optional[Dict[str, Any]] = Field(
        default=None,
