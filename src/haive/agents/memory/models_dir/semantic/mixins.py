...
class PersonalityTraits(BaseModel):
    ...
    communication_style: Literal['formal', 'casual', 'technical', 'friendly', 'direct'] = Field(default='friendly', description='Preferred communication style')
    ...
    language_preferences: list[str] = Field(default_factory=lambda: ['English'], description='Preferred languages')
