...
def create_sequential_multi_agent(agents: List[Agent], name: str = "sequential_multi_agent") -> MultiAgent:
...
def create_parallel_multi_agent(agents: List[Agent], name: str = "parallel_multi_agent") -> MultiAgent:
...
def create_hierarchical_multi_agent(supervisor: Agent, subordinates: List[Agent], name: str = "hierarchical_multi_agent") -> MultiAgent:
