...
class KnowledgeTriple(BaseModel):
    ...
    timestamp: datetime = Field(default_factory=datetime.now, description="When this triple was created")
...
class MemoryItem(BaseModel):
    ...
    relations: List[KnowledgeTriple] = Field(default_factory=list, description="Knowledge relations")
...
class EnhancedMemoryItem(MemoryItem):
    ...
    # Enhanced retrieval
    retrieval_contexts: List[str] = Field(default_factory=list, description="Contexts where retrieved")
