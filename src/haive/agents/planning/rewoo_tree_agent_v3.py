...
- Pure MultiAgent composition
- Proper Pydantic field initialization
- Agents automatically wrapped in nodes by the framework
- Tool aliasing through agent composition
