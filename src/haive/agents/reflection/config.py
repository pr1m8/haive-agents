...
class ReflectionAgentConfig(SimpleAgentConfig):
    ...
    @classmethod
    def from_aug_llm(cls, aug_llm: AugLLMConfig, name: str | None = None, system_prompt: str | None = None, **kwargs) -> "ReflectionAgentConfig":
    ...
    @classmethod
    def from_scratch(cls, system_prompt: str | None = None, model: str = "gpt-4o", temperature: float = 0.7, name: str | None = None, **kwargs) -> "ReflectionAgentConfig":
