...
# from haive.agents.web_nav.aug_llms import web_nav_aug_llm  # Module doesn't exist
...
async def run_web_navigator():
    ...
    #     max_steps=5,
    # )
    raise NotImplementedError("web_nav module not found")
