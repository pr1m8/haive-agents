...
```python
from haive.kg_iterative_refinement import module_function
...
For detailed API documentation, see the [API Reference](../../../docs/source/api/kg_iterative_refinement/index.rst).
