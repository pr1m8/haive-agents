...
class DocumentModifierState(StateSchema):
    ...
    """
    #pass
    name: Optional[str] = Field(default=None,description="The name of the document modifier.")
    description: Optional[str] = Field(default=None,description="The description of the document modifier.")
