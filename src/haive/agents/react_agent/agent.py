...
from haive.agents.react_agent.aug_llms import default_react_llm_runnable_config
from haive.agents.react_agent.state import ReactAgentState
...
class ReactAgentConfig(AgentConfig):
    ...
    visualize_graph_output_name: str | None = Field(default=None, description="Output file for graph visualization.")
    structured_output_model: BaseModel | None = Field(default=None, description="Schema for structured output.")
    default_agent_node: Callable | None = Field(default=None, description="The default agent node function.")
