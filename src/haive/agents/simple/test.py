...
aug_llm = AugLLMConfig(model="gpt-4o", temperature=0.0, system_prompt="You are a helpful assistant that can help me plan my day.",
...
agent.run("Write a plan for building a website",debug=True)