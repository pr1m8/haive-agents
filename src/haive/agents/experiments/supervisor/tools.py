...
def create_supervisor_handoff_tool(supervisor) -> Tool:
    ...
    def delegate_to_agent(agent_name: str, task: str, context: Optional[Dict[str, Any]] = None) -> str:
        ...
        try:
            ...
            if recent:
                ...
                for exec_data in recent[-3:]:  # Show last 3
                    ...
                    task = exec_data.get('task', 'Unknown')[:50] + "..." if len(exec_data.get('task', '')) > 50 else exec_data.get('task', '')
...
def create_agent_creation_tool(supervisor) -> Tool:
    ...
    def create_agent(name: str, description: str, agent_type: str = "simple", config: Optional[Dict[str, Any]] = None) -> str:
        ...
        try:
            ...
            if not hasattr(supervisor, 'agent_creation_enabled') or not supervisor.agent_creation_enabled:
