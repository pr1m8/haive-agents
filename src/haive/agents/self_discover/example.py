...
from haive.agents.self_discover.agent2 import SelfDiscoverAgent, create_self_discover_agent
...
def run_batch_problems(agent: SelfDiscoverAgent, problems: list[str], output_file: str | None = None):
