...
from haive.agents.document_agents.summarizer.map_branch.state import (
    InputState,
    OutputState,
    SummaryState,
)
...
class SummarizerAgentConfig(AgentConfig):
    ...
    def build_agent(self):
        from haive.agents.document_agents.summarizer.map_branch.agent import SummarizerAgent
