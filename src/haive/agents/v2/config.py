...
from haive.agents.v2.state import ReactAgentState
...
ToolsInput = Union[
    ...
    dict[str, BaseTool | StructuredTool | Tool | type[BaseModel] | Callable | list[BaseTool | StructuredTool | Tool | type[BaseModel] | Callable]]
]
