...
class WebNavState(BaseModel):
    ...
    img: str | None = Field(default=None, description="Base64 encoded screenshot (plain, no prefix).")
    ...
    bbox_descriptions: str | None = Field(default=None, description="Formatted bounding box descriptions.")
...
async def run_web_navigator():
    ...
    from haive.agents.web_nav.aug_llms import web_nav_aug_llm
