...
class ToTAgentConfig(AgentConfig):
    ...
    score_llm_config: Optional[AugLLMConfig] = Field(
        default=None,
    ...
    score_function: Optional[Callable] = Field(
        default=None,
    ...
    def from_scratch(cls,
                    ...
                    expand_prompt: Optional[ChatPromptTemplate] = None,
                    score_prompt: Optional[ChatPromptTemplate] = None,
        ...
        if expand_prompt is None:
            expand_prompt = ChatPromptTemplate.from_messages([
                ...
                ("system", "Generate {candidates_per_expansion} different approaches to solve this problem. Be creative and diverse in your thinking."),
