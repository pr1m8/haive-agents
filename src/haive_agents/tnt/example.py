...
from haive_agents.tnt.agent import TaxonomyAgent, TaxonomyAgentConfig
from haive_agents.tnt.state import TaxonomyGenerationState
...
from haive_agents.tnt.models import Doc
...
#print(tutorial_doc)
test_docs = [Doc(id=tutorial_doc[0].metadata['source'], content=tutorial_doc[0].page_content)]
test_docs.append(Doc(id=tutorial_2_doc[0].metadata['source'], content=tutorial_2_doc[0].page_content))
