...
def create_select_engine(
    ...
    custom_prompt: Optional[Union[str, ChatPromptTemplate]] = None,
    **kwargs
) -> AugLLMConfig:
    """
    ...
    default_prompt = ChatPromptTemplate.from_messages([
        ("system", """You are an expert problem solver with strong analytical skills.
    ...
    return AugLLMConfig(
        ...
        prompt_template=prompt if isinstance(prompt, (ChatPromptTemplate, PromptTemplate)) else None,
...
def create_reasoning_engine(
    ...
    **kwargs
    ...
    default_prompt = ChatPromptTemplate.from_messages([
        ("system", """You are an expert problem solver who follows structured reasoning plans precisely.
