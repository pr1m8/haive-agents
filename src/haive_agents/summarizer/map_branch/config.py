...
from haive_agents.document_agents.summarizer.map_branch.state import SummaryState,InputState,OutputState
...
class SummarizerAgentConfig(AgentConfig):
    ...
    def build_agent(self):
        from haive_agents.document_agents.summarizer.map_branch.agent import SummarizerAgent
