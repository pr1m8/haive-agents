...
from haive_agents.document_agents.kg.kg_map_merge.engines import create_parallel_kg_transformer_configs
from haive_agents.document_agents.kg.kg_map_merge.state import KnowledgeGraphState
...
class ParallelKGTransformer(Agent[ParallelKGTransformerConfig]):
    ...
    async def collect_graph_documents(self, state: Union[KnowledgeGraphState, Dict[str, Any]], **kwargs):
