...
class TaskDependency(BaseModel):
    ...
    output_key: Optional[str] = Field(default=None, description="Specific key in the output (if needed)")
...
class CompilerTask(BaseModel):
    ...
    dependencies: List[TaskDependency] = Field(default_factory=list, description="Dependencies on other tasks")
...
class CompilerPlan(Plan):
    ...
    def add_compiler_step(
        ...
        dependencies: List[Union[int, TaskDependency]] = None
    ) -> CompilerStep:
        """
