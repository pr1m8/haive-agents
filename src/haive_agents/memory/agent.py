...
from haive_agents.react.memory.config import MemoryAgentConfig
from haive_agents.react.memory.state import MemoryAgentState, MemoryItem, KnowledgeTriple
...
class MemoryAgent(ReactAgent):
    ...
    def _init_memory_tools(self):
        ...
        def save_memory(memory: str) -> str:
            ...
            try:
                ...
                result = save_unstructured_memories([memory], self.config.vector_store, user_id)
        ...
        def save_structured_memory(subject: str, predicate: str, object_: str) -> str:
            ...
            try:
                ...
                return f"Error saving structured memory: {str(e)}"
    ...
    def _extract_memories(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            extracted_content = extraction_result.content if hasattr(extraction_result, "content") else str(extraction_result)
    ...
    def _save_memories(self, state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            if memory_type == "structured":
                ...
                if unstructured_memories:
                    save_unstructured_memories(unstructured_memories, self.config.vector_store, user_id)
