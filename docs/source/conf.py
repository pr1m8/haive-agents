...
autoapi_prepare_jinja_env = lambda jinja_env: jinja_env.filters.update(
    {
        ...
        "clean_module": lambda x: x.replace("haive.agents.", ""),
    }
)
...
html_theme_options = {
    ...
    "announcement": "🤖 <b>haive-agents</b> - Pre-built AI agents for the Haive Framework",
    "source_repository": "https://github.com/haive-ai/haive",
    "source_branch": "main",
    "source_directory": "packages/haive-agents/docs/",
    # Additional Furo features
    "top_of_page_button": "edit",  # Show edit button at top of pages
}

# Additional HTML configuration
html_title = "haive-agents"
html_short_title = "haive-agents"
...
autotyping_module_names = ["haive.agents"]
...
# Sitemap
html_baseurl = "https://docs.haive.ai/packages/haive-agents/"
...
# OpenGraph
ogp_site_url = "https://docs.haive.ai/packages/haive-agents/"
ogp_site_name = "haive-agents Documentation"
ogp_social_cards = {
    "enable": True,
}
...
html_context = {
    ...
    "github_repo": "haive",
    "github_version": "main",
    "conf_py_path": "/packages/haive-agents/docs/source/",
}
...
tippy_custom_tips = {
    # Agent modules
    "haive.agents.simple": "Basic agent implementations for straightforward LLM interactions.",
    "haive.agents.react": "ReAct (Reasoning and Acting) agents for complex problem solving.",
    "haive.agents.multi": "Multi-agent orchestration and coordination systems.",
    "haive.agents.rag": "Retrieval-Augmented Generation agents for knowledge-based tasks.",
    "haive.agents.planning": "Planning and reasoning agents for step-by-step problem solving.",
    "haive.agents.research": "Research agents for information gathering and analysis.",
    # Key agent classes
    "SimpleAgent": "Basic agent for straightforward LLM interactions with minimal setup.",
    "SimpleAgentV2": "Enhanced simple agent with memory and state management.",
    "SimpleAgentV3": "Latest simple agent with hooks, recompilation, and advanced features.",
    "ReactAgent": "Agent using ReAct pattern - interleaves reasoning with tool use.",
    "MultiAgent": "Orchestrates multiple agents in sequential or parallel workflows.",
    "EnhancedMultiAgentV4": "Advanced multi-agent system with dynamic composition.",
    "BaseRAGAgent": "Foundation for retrieval-augmented generation agents.",
    ...
    # Agent patterns
    "ReAct": "Reasoning and Acting - pattern where agents think through problems step by step.",
    "Chain-of-Thought": "Prompting technique that encourages step-by-step reasoning.",
    "Self-Reflection": "Agents that review and improve their own outputs.",
    "Tool Use": "Agents calling external functions or APIs to accomplish tasks.",
    "Memory Systems": "Various approaches to giving agents persistent memory.",
    "Supervisor Pattern": "One agent coordinating and delegating to other agents.",
    # Common terms
    ...
    "state": "Agent's internal data and conversation history.",
    "workflow": "Sequence of agent actions to complete a task.",
    ...
    "hook": "Extension point for customizing agent behavior.",
}
...
enum_tools_namespace = "haive.agents"
