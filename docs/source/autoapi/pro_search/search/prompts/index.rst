...
.. autoapisummary::
   ...
   pro_search.search.prompts.CONVERSATIONAL_SEARCH_SYSTEM
   pro_search.search.prompts.ERROR_RECOVERY_SYSTEM
   pro_search.search.prompts.ERROR_RECOVERY_USER
   pro_search.search.prompts.FOLLOW_UP_SYSTEM
   pro_search.search.prompts.FOLLOW_UP_USER
   pro_search.search.prompts.QUERY_GENERATION_SYSTEM
   pro_search.search.prompts.QUERY_GENERATION_USER
   pro_search.search.prompts.QUERY_REASONING_SYSTEM
   pro_search.search.prompts.QUERY_REASONING_USER
   pro_search.search.prompts.RESULT_ANALYSIS_SYSTEM
   pro_search.search.prompts.RESULT_ANALYSIS_USER
   pro_search.search.prompts.SYNTHESIS_SYSTEM
   pro_search.search.prompts.SYNTHESIS_USER
   pro_search.search.prompts.conversational_search_prompt
   pro_search.search.prompts.error_recovery_prompt
   pro_search.search.prompts.follow_up_prompt
   pro_search.search.prompts.query_generation_prompt
   pro_search.search.prompts.query_reasoning_prompt
   pro_search.search.prompts.result_analysis_prompt
   pro_search.search.prompts.synthesis_prompt
