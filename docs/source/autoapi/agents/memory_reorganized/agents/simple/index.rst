agents.memory_reorganized.agents.simple
=======================================
...
.. autoapisummary::
   ...
   agents.memory_reorganized.agents.simple.EntityNode
   agents.memory_reorganized.agents.simple.GraphTransformer
   agents.memory_reorganized.agents.simple.MEMORY_REWRITE_PROMPT
   agents.memory_reorganized.agents.simple.MEMORY_SUMMARIZATION_PROMPT
   agents.memory_reorganized.agents.simple.RUNNING_SUMMARY_UPDATE_PROMPT
   agents.memory_reorganized.agents.simple.logger
...
.. py:class:: SimpleMemoryAgent
   ...
   .. py:method:: check_tokens_node(state: haive.agents.memory_reorganized.base.memory_state_original.MemoryState) -> dict[str, Any]
   ...
   .. py:method:: consolidate_memories_node(state: haive.agents.memory_reorganized.base.token_state.MemoryStateWithTokens) -> langgraph.types.Command
   ...
   .. py:method:: create_summary_node(state: haive.agents.memory_reorganized.base.token_state.MemoryStateWithTokens) -> langgraph.types.Command
   ...
   .. py:method:: emergency_compress_node(state: haive.agents.memory_reorganized.base.token_state.MemoryStateWithTokens) -> langgraph.types.Command
   ...
   .. py:method:: extract_entities_node(state: haive.agents.memory_reorganized.base.token_state.MemoryStateWithTokens) -> langgraph.types.Command
   ...
   .. py:method:: extract_relationships_node(state: haive.agents.memory_reorganized.base.token_state.MemoryStateWithTokens) -> langgraph.types.Command
   ...
   .. py:method:: pre_hook_node(state: haive.agents.memory_reorganized.base.token_state.MemoryStateWithTokens) -> langgraph.types.Command
   ...
   .. py:method:: process_memory_node(state: haive.agents.memory_reorganized.base.token_state.MemoryStateWithTokens) -> langgraph.types.Command
   ...
   .. py:method:: rewrite_memories_node(state: haive.agents.memory_reorganized.base.memory_state_original.MemoryState) -> dict[str, Any]
   ...
   .. py:method:: route_from_pre_hook(state: haive.agents.memory_reorganized.base.token_state.MemoryStateWithTokens) -> str
   ...
   .. py:method:: summarize_critical_node(state: haive.agents.memory_reorganized.base.token_state.MemoryStateWithTokens) -> langgraph.types.Command
   ...
   .. py:method:: summarize_memories_node(state: haive.agents.memory_reorganized.base.memory_state_original.MemoryState) -> dict[str, Any]
   ...
   .. py:method:: summarize_warning_node(state: haive.agents.memory_reorganized.base.token_state.MemoryStateWithTokens) -> langgraph.types.Command
   ...
   .. py:method:: transform_to_graph_node(state: haive.agents.memory_reorganized.base.token_state.MemoryStateWithTokens) -> langgraph.types.Command
   ...
   .. py:method:: update_graph_node(state: haive.agents.memory_reorganized.base.token_state.MemoryStateWithTokens) -> langgraph.types.Command
   ...
   .. py:method:: update_running_summary_node(state: haive.agents.memory_reorganized.base.memory_state_original.MemoryState) -> dict[str, Any]
   ...
   .. py:method:: update_summary_node(state: haive.agents.memory_reorganized.base.token_state.MemoryStateWithTokens) -> langgraph.types.Command
   ...
   .. py:attribute:: token_tracker
      :type:  haive.agents.memory_reorganized.core.token_tracker.TokenTracker
      :value: None
...
.. py:class:: TokenAwareMemoryConfig

   Bases: :py:obj:`haive.agents.memory_reorganized.core.memory_tools.MemoryConfig`
