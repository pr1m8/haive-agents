agents.memory_reorganized.agents.ltm
====================================
...
.. autoapisummary::
   ...
   agents.memory_reorganized.agents.ltm.logger
...
.. py:class:: LongTermMemoryStore(storage_path: str = './memory_store')
   ...
   .. py:method:: get_memories(user_id: str = None, limit: int = None) -> list[MemoryEntry]
   ...
   .. py:method:: search_memories(query: str, user_id: str = None, limit: int = 5) -> list[MemoryEntry]
...
.. py:class:: MemoryEntry(/, **data: Any)
   ...
   .. py:method:: mark_accessed(query: str = None, relevance: float = None)
