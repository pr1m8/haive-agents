agents.memory_reorganized.base.agent
====================================

.. py:module:: agents.memory_reorganized.base.agent
...
.. autoapi-nested-parse::
   ...
   .. autolink-examples:: agents.memory_reorganized.base.agent
      :collapse:
...
.. autoapisummary::
   ...
   agents.memory_reorganized.base.agent.logger
...
.. autoapisummary::
   ...
   agents.memory_reorganized.base.agent.MemoryAgent


Module Contents
---------------

.. py:class:: MemoryAgent(config: agents.react.memory.config.MemoryAgentConfig)

   Bases: :py:obj:`agents.react.react.agent.ReactAgent`


   Memory Agent implementation that extends ReactAgent.

   Adds long-term memory capabilities for persisting information about users across
   conversations.
