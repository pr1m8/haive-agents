agents.memory_reorganized.coordination.integrated_memory_system
===============================================================
...
.. py:class:: IntegratedMemorySystem(user_id: str = 'default_user', neo4j_config: dict[str, Any] | None = None, vector_store_path: haive.agents.memory_v2.graph_memory_agent.Optional[str] = None, engine: haive.agents.memory_v2.graph_memory_agent.Optional[haive.core.engine.aug_llm.AugLLMConfig] = None)

   Combines multiple memory systems for comprehensive memory management.

   This system intelligently routes memory operations to the most appropriate subsystem
   ...
   .. py:method:: _init_react_memory(vector_store_path: haive.agents.memory_v2.graph_memory_agent.Optional[str])
