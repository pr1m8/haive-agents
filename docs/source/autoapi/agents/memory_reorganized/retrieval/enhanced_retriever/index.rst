agents.memory_reorganized.retrieval.enhanced_retriever
======================================================
...
.. autoapisummary::
   ...
   agents.memory_reorganized.retrieval.enhanced_retriever.logger
...
.. py:class:: EnhancedMemoryRetriever(config: EnhancedRetrieverConfig)
   ...
   .. py:method:: retrieve_memories(query: str, memory_types: list[haive.agents.memory.core.types.MemoryType] | None = None, importance_threshold: haive.agents.memory.core.types.Optional[float] = None, time_range: tuple[datetime.datetime, datetime.datetime] | None = None, limit: haive.agents.memory.core.types.Optional[int] = None, include_metadata: bool = True, namespace: tuple[str, Ellipsis] | None = None) -> EnhancedQueryResult
      :async:
...
.. py:class:: EnhancedQueryResult(/, **data: Any)
   ...
   .. py:attribute:: expanded_query
      :type:  haive.agents.memory.core.types.Optional[str]
      :value: None
   ...
   .. py:attribute:: query_intent
      :type:  haive.agents.memory.core.types.Optional[haive.agents.memory.core.types.MemoryQueryIntent]
      :value: None
