...
.. py:module:: agents.planning.plan_and_execute.v2.prompts
...
.. autoapi-nested-parse::
   ...
   .. autolink-examples:: agents.planning.plan_and_execute.v2.prompts
      :collapse:
...
.. autoapisummary::
   ...
   agents.planning.plan_and_execute.v2.prompts.EXECUTOR_PROMPT
   agents.planning.plan_and_execute.v2.prompts.PLANNER_PROMPT
   agents.planning.plan_and_execute.v2.prompts.REPLANNER_PROMPT
...
.. py:data:: EXECUTOR_PROMPT
   ...
   .. code-block:: python
      ...
      """You are a task executor. You will be given a specific step from a plan to execute.
...
.. py:data:: PLANNER_PROMPT
   ...
   .. code-block:: python
      ...
      """You are a strategic planner. Given a user objective, create a simple step-by-step plan to accomplish it.
...
.. py:data:: REPLANNER_PROMPT
   ...
   .. code-block:: python
      ...
      """You are a replanner. Review the original objective, current plan, and completed steps to decide what to do next.
