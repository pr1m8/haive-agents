...
:py:mod:`agents.memory.search.base`
===================================

.. py:module:: agents.memory.search.base
...
.. autolink-examples:: agents.memory.search.base
   :collapse:
...
.. autoapisummary::
   ...
   agents.memory.search.base.BaseSearchAgent
   agents.memory.search.base.SearchResponse
...
.. autoclass:: agents.memory.search.base.BaseSearchAgent
   :members:
   :undoc-members:
   :show-inheritance:
...
.. autopydantic_model:: agents.memory.search.base.SearchResponse
   :members:
   :undoc-members:
   :show-inheritance:
...
.. autoapisummary::
   ...
   agents.memory.search.base.extract_memory_items
   agents.memory.search.base.format_search_context
   agents.memory.search.base.get_response_model
   agents.memory.search.base.get_search_instructions
   agents.memory.search.base.get_system_prompt
