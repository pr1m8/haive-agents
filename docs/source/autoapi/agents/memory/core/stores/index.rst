...
.. autoapisummary::
   ...
   agents.memory.core.stores.logger
...
.. py:class:: MemoryStoreManager(config: MemoryStoreConfig)
   ...
   .. py:method:: _calculate_ranking_score(memory: dict[str, Any], query_intent: haive.agents.memory.core.types.MemoryQueryIntent | None = None) -> float
   ...
   .. py:method:: consolidate_memories(namespace: tuple[str, Ellipsis] | None = None, max_age_hours: int | None = None, dry_run: bool = False) -> haive.agents.memory.core.types.MemoryConsolidationResult
      :async:
   ...
   .. py:method:: retrieve_memories(query: str, namespace: tuple[str, Ellipsis] | None = None, memory_types: list[haive.agents.memory.core.types.MemoryType] | None = None, limit: int | None = None, time_range: tuple[datetime.datetime, datetime.datetime] | None = None, importance_threshold: float | None = None) -> list[dict[str, Any]]
      :async:
   ...
   .. py:method:: store_memory(content: str, namespace: tuple[str, Ellipsis] | None = None, user_context: dict[str, Any] | None = None, conversation_context: dict[str, Any] | None = None, force_classification: haive.agents.memory.core.types.MemoryType | None = None, importance_override: float | None = None) -> str
      :async:
   ...
   .. py:method:: update_memory(memory_id: str, content: str | None = None, additional_metadata: dict[str, Any] | None = None, reclassify: bool = False) -> bool
      :async:
