...
.. autoapisummary::
   ...
   agents.memory.unified_memory_api.logger
...
.. py:class:: UnifiedMemorySystem(config: MemorySystemConfig)
   ...
   .. py:method:: retrieve_memories(query: str, limit: int = 10, namespace: tuple[str, Ellipsis] | None = None, memory_types: list[haive.agents.memory.core.types.MemoryType] | None = None, use_graph_rag: bool = True, use_multi_agent: bool = True) -> MemorySystemResult
      :async:
   ...
   .. py:method:: store_memory(content: str, namespace: tuple[str, Ellipsis] | None = None, memory_type: haive.agents.memory.core.types.MemoryType | None = None, importance: float | None = None, metadata: dict[str, Any] | None = None) -> MemorySystemResult
      :async:
