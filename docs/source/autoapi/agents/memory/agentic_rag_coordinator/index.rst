...
.. autoapisummary::
   ...
   agents.memory.agentic_rag_coordinator.logger
...
.. py:class:: AgenticRAGCoordinator(config: AgenticRAGCoordinatorConfig)
   ...
   .. py:method:: _execute_single_strategy(strategy_name: str, query: str, limit: int | None, memory_types: list[haive.agents.memory.core.types.MemoryType] | None, namespace: tuple[str, Ellipsis] | None) -> dict[str, Any]
      :async:
   ...
   .. py:method:: _execute_strategies(strategies: list[str], query: str, limit: int | None, memory_types: list[haive.agents.memory.core.types.MemoryType] | None, namespace: tuple[str, Ellipsis] | None) -> dict[str, Any]
      :async:
   ...
   .. py:method:: retrieve_memories(query: str, limit: int | None = None, memory_types: list[haive.agents.memory.core.types.MemoryType] | None = None, namespace: tuple[str, Ellipsis] | None = None, force_strategies: list[str] | None = None) -> AgenticRAGResult
      :async:
   ...
   .. py:attribute:: enhanced_retriever_config
      :type:  haive.agents.memory.enhanced_retriever.EnhancedRetrieverConfig | None
      :value: None
   ...
   .. py:attribute:: graph_rag_config
      :type:  haive.agents.memory.graph_rag_retriever.GraphRAGRetrieverConfig | None
      :value: None



   .. py:attribute:: kg_generator
      :type:  haive.agents.memory.kg_generator_agent.KGGeneratorAgent | None
      :value: None
