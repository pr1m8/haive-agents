...
.. py:module:: agents.memory.graph_rag_retriever
...
.. autoapi-nested-parse::
   ...
   .. autolink-examples:: agents.memory.graph_rag_retriever
      :collapse:
...
.. autoapisummary::
   ...
   agents.memory.graph_rag_retriever.logger
...
.. autoapisummary::
   ...
   agents.memory.graph_rag_retriever.GraphRAGResult
   agents.memory.graph_rag_retriever.GraphRAGRetriever
   agents.memory.graph_rag_retriever.GraphRAGRetrieverConfig
...
.. py:class:: GraphRAGRetriever(config: GraphRAGRetrieverConfig)
   ...
   .. py:method:: retrieve_memories(query: str, limit: int | None = None, memory_types: list[haive.agents.memory.core.types.MemoryType] | None = None, namespace: tuple[str, Ellipsis] | None = None, enable_graph_traversal: bool = True, max_graph_depth: int | None = None) -> GraphRAGResult
      :async:
