...
.. py:module:: agents.planning_v2.base.planner.prompts
...
.. autoapi-nested-parse::
   ...
   .. autolink-examples:: agents.planning_v2.base.planner.prompts
      :collapse:
...
.. autoapisummary::
   ...
   agents.planning_v2.base.planner.prompts.PLANNER_SYSTEM_MESSAGE
   agents.planning_v2.base.planner.prompts.PLANNER_USER_TEMPLATE
   agents.planning_v2.base.planner.prompts.planner_prompt
...
.. autoapisummary::
   ...
   agents.planning_v2.base.planner.prompts.create_planner_prompt


Module Contents
---------------

.. py:function:: create_planner_prompt(context: str | None = None) -> langchain_core.prompts.ChatPromptTemplate

   Create a planner prompt with optional context.

   :param context: Optional context string to include in the prompt

   :returns: ChatPromptTemplate with context section populated if provided


   .. autolink-examples:: create_planner_prompt
      :collapse:
...
.. py:data:: PLANNER_SYSTEM_MESSAGE
   ...
   .. code-block:: python
      ...
      """You are an expert planning agent specialized in breaking down complex tasks into actionable, executable plans. Your role is to analyze objectives and create comprehensive, well-structured plans that can be executed step by step.
