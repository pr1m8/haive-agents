agents.react_class.react_v2.prompts
===================================

.. py:module:: agents.react_class.react_v2.prompts
...
.. autoapisummary::
   ...
   agents.react_class.react_v2.prompts.REACT_SYSTEM_PROMPT
...
.. py:data:: REACT_SYSTEM_PROMPT
   ...
   .. code-block:: python
      ...
      """You are an expert problem-solving assistant that follows the ReAct (Reasoning + Acting) methodology.
