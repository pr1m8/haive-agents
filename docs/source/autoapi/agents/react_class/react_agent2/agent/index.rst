agents.react_class.react_agent2.agent
=====================================
...
.. autoapisummary::
   ...
   agents.react_class.react_agent2.agent.logger
...
.. py:class:: ReactAgent
   ...
   .. py:method:: _route_based_on_messages(state: dict[str, Any]) -> str

      Determine the routing based on message content.

      :param state: Current state

      :returns: "tools", "structured_response", or "end"
...
.. py:class:: ReactAgentConfig(/, **data: Any)
