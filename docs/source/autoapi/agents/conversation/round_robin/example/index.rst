...
.. py:function:: example_custom_round_robin() -> None
   ...
   .. autolink-examples:: example_custom_round_robin
      :collapse:

.. py:function:: example_panel_discussion() -> None

   Simulate a panel discussion with round-robin format.


   .. autolink-examples:: example_panel_discussion
      :collapse:

.. py:function:: example_simple_round_robin() -> None
