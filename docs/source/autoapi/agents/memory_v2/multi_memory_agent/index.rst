...
.. autoapisummary::
   ...
   agents.memory_v2.multi_memory_agent.HAS_GRAPH_MEMORY
   agents.memory_v2.multi_memory_agent.HAS_RAG_MEMORY
   agents.memory_v2.multi_memory_agent.logger
...
.. py:class:: MultiMemoryConfig(/, **data: Any)
   ...
   .. py:attribute:: simple_memory_config
      :type:  agents.memory_v2.simple_memory_agent.TokenAwareMemoryConfig | None
      :value: None
...
.. py:class:: MultiMemoryState
   ...
   Bases: :py:obj:`agents.memory_v2.memory_state_with_tokens.MemoryStateWithTokens`
