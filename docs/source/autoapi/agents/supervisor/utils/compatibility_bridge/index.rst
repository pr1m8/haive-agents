...
.. autoapisummary::
   ...
   agents.supervisor.utils.compatibility_bridge.logger
...
.. py:class:: DynamicMultiAgentSupervisor
   ...
   Bases: :py:obj:`haive.agents.multi.compatibility.MultiAgent`
...
.. py:class:: ReactMultiAgentSupervisor
   ...
   .. py:attribute:: execution_mode
      :type:  haive.agents.multi.compatibility.ExecutionMode
      :value: None
