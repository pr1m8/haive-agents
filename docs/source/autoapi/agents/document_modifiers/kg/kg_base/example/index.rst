...
.. autoapisummary::
   ...
   agents.document_modifiers.kg.kg_base.example.advanced_example
...
.. py:function:: advanced_example() -> None
   ...
   .. autolink-examples:: advanced_example
      :collapse:

.. py:function:: basic_example() -> None
...
.. py:function:: schema_validation_example() -> None

   Demonstrate schema validation and error handling.


   .. autolink-examples:: schema_validation_example
      :collapse:

.. py:function:: type_hints_example() -> None
