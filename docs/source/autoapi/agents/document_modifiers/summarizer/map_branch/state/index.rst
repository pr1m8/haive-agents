...
.. py:class:: InputState(/, **data: Any)
   ...
   .. py:method:: normalize_contents(v) -> Any
      :classmethod:
...
.. py:class:: OutputState(/, **data: Any)
   ...
   .. py:attribute:: final_summary
      :type:  str
      :value: None



.. py:class:: SummaryState(/, **data: Any)
   ...
   .. autolink-examples:: SummaryState
      :collapse:

   .. py:attribute:: collapsed_summaries
   ...
   .. py:attribute:: summaries
      :type:  Annotated[list, operator.add]
      :value: None
