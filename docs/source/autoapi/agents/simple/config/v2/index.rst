agents.simple.config.v2
=======================

.. py:module:: agents.simple.config.v2
...
.. autoapi-nested-parse::
   ...
   .. autolink-examples:: agents.simple.config.v2
      :collapse:
...
.. autoapisummary::
   ...
   agents.simple.config.v2.logger
...
.. autoapisummary::
   ...
   agents.simple.config.v2.SimpleAgentConfig
...
.. py:class:: SimpleAgentConfig
   ...
   .. py:method:: validate_engine(v) -> haive.core.engine.aug_llm.AugLLMConfig
      :classmethod:
   ...
   .. py:method:: validate_mappings(v, info) -> dict[str, str] | None
      :classmethod:
